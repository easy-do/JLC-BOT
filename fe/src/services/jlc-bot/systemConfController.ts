...
export async function getConfInfo(
  ...
  return request<API.RSystemConf>(`/api/conf/info/${param0}`, {
    method: 'GET',
    params: { ...queryParams },
    ...(options || {}),
  });
...
export async function saveConf(body: API.SystemConf, options?: { [key: string]: any }) {
...
export async function updateConf(body: API.SystemConf, options?: { [key: string]: any }) {
